...
class Meta extends Model
{
    ...
    const STRING_ARRAY = ['tel_number', 'alt_number', 'avatar', 'national_code', 'postal_code', 'education',
        'account_full_name', 'account_number', 'sheba', 'bank_name', 'card_number', 'artist_banner', 'address',
        'gender', 'bio', 'licenses'];
